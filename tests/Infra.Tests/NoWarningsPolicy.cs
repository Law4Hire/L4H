...
public class NoWarningsPolicy
{
    ...
    public void EditorConfig_ShouldHaveKeyAnalyzersAsErrors()
    {
        ...
        // Act & Assert
        editorConfigContent.Should().Contain("dotnet_diagnostic.CA1305.severity = none",
            "Culture-aware formatting should be suppressed for now");
        ...
        editorConfigContent.Should().Contain("dotnet_diagnostic.CA2016.severity = none",
            "Cancellation token flow should be suppressed for now");
    }
    ...
    public void EditorConfig_ShouldHavePerformanceAnalyzersAsErrors()
    {
        ...
        editorConfigContent.Should().Contain("dotnet_diagnostic.CA1829.severity = suggestion", 
            "Performance analyzer CA1829 should be a suggestion");
    }
}
