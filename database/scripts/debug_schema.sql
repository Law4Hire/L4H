CREATE TABLE [AdminPricingEntries] (
    ...
    CONSTRAINT [PK_AdminPricingEntries] PRIMARY KEY ([Id])
);
GO
...
CREATE TABLE [InterviewQuestionCategories] (
    [Id] uniqueidentifier NOT NULL,
    ...
    [CreatedAt] datetime2 NOT NULL,
    [UpdatedAt] datetime2 NOT NULL,
    CONSTRAINT [PK_InterviewQuestionCategories] PRIMARY KEY ([Id])
);
GO
...
CREATE TABLE [SiteConfigurations] (
    ...
    [CorporatePhone] nvarchar(50) NOT NULL,
    [Email] nvarchar(255) NOT NULL,
    ...
    [ExchangeTenantId] nvarchar(100) NULL,
    [ExchangeClientId] nvarchar(100) NULL,
    [ExchangeClientSecret] nvarchar(500) NULL,
    [ExchangeSystemEmail] nvarchar(255) NULL,
    [StripePublishableKey] nvarchar(200) NULL,
    [StripeSecretKey] nvarchar(500) NULL,
    [StripeWebhookSecret] nvarchar(200) NULL,
    [RoundBillingUp] bit NOT NULL,
    [CreatedAt] datetime2 NOT NULL,
    [UpdatedAt] datetime2 NOT NULL,
...
CREATE TABLE [VisaLibraryTiles] (
    ...
    [CreatedAt] datetime2 NOT NULL,
    [UpdatedAt] datetime2 NOT NULL,
    CONSTRAINT [PK_VisaLibraryTiles] PRIMARY KEY ([Id])
);
GO
...
CREATE TABLE [Users] (
    ...
    [IsLegalProfessional] bit NOT NULL,
    [IsActive] bit NOT NULL,
    [AttorneyId] int NULL,
    ...
    CONSTRAINT [FK_Users_Attorneys_AttorneyId] FOREIGN KEY ([AttorneyId]) REFERENCES [Attorneys] ([Id]) ON DELETE SET NULL
);
GO
...
CREATE TABLE [VisaLibraryTileMappings] (
    [Id] uniqueidentifier NOT NULL,
    [TileId] uniqueidentifier NOT NULL,
    [VisaTypeId] int NOT NULL,
    [DisplayOrder] int NOT NULL,
    [CreatedAt] datetime2 NOT NULL,
    CONSTRAINT [PK_VisaLibraryTileMappings] PRIMARY KEY ([Id]),
    CONSTRAINT [FK_VisaLibraryTileMappings_VisaLibraryTiles_TileId] FOREIGN KEY ([TileId]) REFERENCES [VisaLibraryTiles] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_VisaLibraryTileMappings_VisaTypes_VisaTypeId] FOREIGN KEY ([VisaTypeId]) REFERENCES [VisaTypes] ([Id]) ON DELETE CASCADE
);
GO
...
CREATE TABLE [Cases] (
    ...
    [IsVisaLockedByAttorney] bit NOT NULL,
    [VisaLockedAt] datetime2 NULL,
    ...
    CONSTRAINT [FK_Cases_VisaTypes_AttorneySelectedVisaTypeId] FOREIGN KEY ([AttorneySelectedVisaTypeId]) REFERENCES [VisaTypes] ([Id]),
...
CREATE TABLE [InterviewQuestions] (
    ...
    [ParentOptionValue] nvarchar(max) NULL,
    [PageConfig] nvarchar(4000) NULL,
    [CreatedAt] datetime2 NOT NULL,
    [UpdatedAt] datetime2 NOT NULL,
    [CreatedByUserId] uniqueidentifier NULL,
    [UpdatedByUserId] uniqueidentifier NULL,
    CONSTRAINT [PK_InterviewQuestions] PRIMARY KEY ([Id]),
    CONSTRAINT [FK_InterviewQuestions_InterviewQuestions_ParentId] FOREIGN KEY ([ParentId]) REFERENCES [InterviewQuestions] ([Id]),
...
CREATE TABLE [CaseVisaTypes] (
    ...
    [CreatedAt] datetime2 NOT NULL,
    CONSTRAINT [PK_CaseVisaTypes] PRIMARY KEY ([Id]),
    CONSTRAINT [FK_CaseVisaTypes_Cases_CaseId] FOREIGN KEY ([CaseId]) REFERENCES [Cases] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_CaseVisaTypes_VisaTypes_VisaTypeId] FOREIGN KEY ([VisaTypeId]) REFERENCES [VisaTypes] ([Id]) ON DELETE NO ACTION
);
GO
...
CREATE TABLE [InterviewSessions] (
    ...
    [AnonymousToken] uniqueidentifier NULL,
    [Status] nvarchar(50) NOT NULL,
...
CREATE TABLE [MessageThreads] (
    ...
    CONSTRAINT [FK_MessageThreads_Users_RecipientUserId] FOREIGN KEY ([RecipientUserId]) REFERENCES [Users] ([Id]) ON DELETE NO ACTION
);
GO
...
CREATE TABLE [TimeEntries] (
    ...
    CONSTRAINT [FK_TimeEntries_Cases_CaseId] FOREIGN KEY ([CaseId]) REFERENCES [Cases] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_TimeEntries_Clients_ClientId] FOREIGN KEY ([ClientId]) REFERENCES [Clients] ([Id])
);
GO
...
CREATE TABLE [QuestionOptions] (
    ...
    [TargetQuestionId] uniqueidentifier NULL,
    [TargetPagePath] nvarchar(max) NULL,
    [QualifiedVisaCodes] nvarchar(max) NULL,
    [CreatedAt] datetime2 NOT NULL,
    [UpdatedAt] datetime2 NOT NULL,
...
CREATE TABLE [AdoptionDocuments] (
    ...
    CONSTRAINT [FK_AdoptionDocuments_Uploads_UploadId] FOREIGN KEY ([UploadId]) REFERENCES [Uploads] ([Id]) ON DELETE SET NULL
);
GO
...
CREATE INDEX [IX_CaseVisaTypes_CaseId_DisplayOrder] ON [CaseVisaTypes] ([CaseId], [DisplayOrder]);
GO


CREATE INDEX [IX_CaseVisaTypes_IsPrimary] ON [CaseVisaTypes] ([IsPrimary]);
GO


CREATE INDEX [IX_CaseVisaTypes_VisaTypeId] ON [CaseVisaTypes] ([VisaTypeId]);
GO
...
CREATE INDEX [IX_InterviewQuestionCategories_DisplayOrder] ON [InterviewQuestionCategories] ([DisplayOrder]);
GO


CREATE INDEX [IX_InterviewQuestionCategories_IsActive] ON [InterviewQuestionCategories] ([IsActive]);
GO


CREATE UNIQUE INDEX [IX_InterviewQuestionCategories_Value] ON [InterviewQuestionCategories] ([Value]);
GO
...
CREATE INDEX [IX_MessageThreads_RecipientUserId] ON [MessageThreads] ([RecipientUserId]);
GO
...
CREATE INDEX [IX_SiteContents_ContentType] ON [SiteContents] ([ContentType]);
GO


CREATE INDEX [IX_SiteContents_IsPublished] ON [SiteContents] ([IsPublished]);
GO


CREATE INDEX [IX_SiteContents_PublishedAt] ON [SiteContents] ([PublishedAt]);
GO
...
CREATE INDEX [IX_VisaEvaluations_LockedByUserId] ON [VisaEvaluations] ([LockedByUserId]);
GO
...
CREATE INDEX [IX_VisaLibraryTileMappings_TileId] ON [VisaLibraryTileMappings] ([TileId]);
GO


CREATE INDEX [IX_VisaLibraryTileMappings_VisaTypeId] ON [VisaLibraryTileMappings] ([VisaTypeId]);
GO
