...
namespace L4H.Infrastructure.Migrations
{
    ...
    [Migration("20260305234221_AddInterviewSessionIsFastPath")]
    partial class AddInterviewSessionIsFastPath
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("L4H.Infrastructure.Entities.CaseVisaType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CaseId", "DisplayOrder");

                    b.ToTable("CaseVisaTypes");
                });
            ...
            modelBuilder.Entity("L4H.Infrastructure.Entities.FormDependencyEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("DependentFormId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DependentFormId");

                    b.HasIndex("ParentFormId");

                    b.HasIndex("VisaTypeId");

                    b.HasIndex("ParentFormId", "VisaTypeId");

                    b.ToTable("FormDependencies");
                });
            ...
            modelBuilder.Entity("L4H.Infrastructure.Entities.FormPricingEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal?>("LLCFeePercentage")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal>("LLCFeeUSD")
                        .HasColumnType("decimal(10,2)");

                    b.Property<decimal?>("LawyerPriceUSD")
                        .HasColumnType("decimal(10,2)");

                    b.Property<decimal?>("ParalegalPriceUSD")
                        .HasColumnType("decimal(10,2)");

                    b.Property<decimal?>("SelfFilePriceUSD")
                        .HasColumnType("decimal(10,2)");
            ...
            modelBuilder.Entity("L4H.Infrastructure.Entities.FormVisaTypeMappingEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("FormId", "VisaTypeId")
                        .IsUnique();

                    b.ToTable("FormVisaTypeMappings");
                });
            ...
            modelBuilder.Entity("L4H.Infrastructure.Entities.InterviewQuestionCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("InterviewQuestionCategories");
                });

            modelBuilder.Entity("L4H.Infrastructure.Entities.InterviewQuestionEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("DiscriminatesVisaCodes")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.Property<int>("SelectionWeight")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("L4H.Infrastructure.Entities.QuestionOptionEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("QualifiedVisaCodes")
                        .HasColumnType("nvarchar(max)");

                    b.Property<Guid>("QuestionId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("TargetPagePath")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("L4H.Infrastructure.Entities.SiteConfiguration", b =>
                {
                    ...
                    b.Property<string>("ExchangeClientId")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("ExchangeClientSecret")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("ExchangeSystemEmail")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");

                    b.Property<string>("ExchangeTenantId")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.Property<bool>("RoundBillingUp")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("L4H.Infrastructure.Entities.SiteContent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("L4H.Infrastructure.Entities.VisaLibraryTile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("VisaLibraryTiles");
                });

            modelBuilder.Entity("L4H.Infrastructure.Entities.VisaLibraryTileMapping", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("VisaLibraryTileMappings");
                });
            ...
            modelBuilder.Entity("L4H.Infrastructure.Entities.FormDependencyEntity", b =>
                {
                    b.HasOne("L4H.Infrastructure.Entities.USCISFormEntity", "DependentForm")
                        .WithMany("RequiredByForms")
                        .HasForeignKey("DependentFormId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("L4H.Infrastructure.Entities.USCISFormEntity", "ParentForm")
            ...
            modelBuilder.Entity("L4H.Infrastructure.Entities.InterviewQuestionEntity", b =>
                {
                    ...
                    b.HasOne("L4H.Infrastructure.Entities.InterviewQuestionEntity", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("L4H.Infrastructure.Entities.VisaLibraryTileMapping", b =>
                {
                    b.HasOne("L4H.Infrastructure.Entities.VisaLibraryTile", "Tile")
                        .WithMany("VisaTypeMappings")
