...
public class AttorneysSeeder : ISeedTask
{
    private readonly L4HDbContext _context;
    private readonly ILogger<AttorneysSeeder> _logger;

    public string Name => "Attorneys";

    public AttorneysSeeder(L4HDbContext context, ILogger<AttorneysSeeder> logger)
    {
        _context = context;
        _logger = logger;
    }
    ...
    {
        _logger.LogInformation("Seeding Attorneys...");
        ...
        foreach (var attorney in attorneys)
        {
            ...
            if (existing == null)
            {
                ...
                _logger.LogInformation("Added attorney: {Name}", attorney.Name);
            }
            else
            {
