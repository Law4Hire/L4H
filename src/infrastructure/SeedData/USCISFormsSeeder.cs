...
public class USCISFormsSeeder : ISeedTask
{
    ...
    private List<FormSeedData> GetDefaultForms()
    {
        return new List<FormSeedData>
        {
            ...
            new FormSeedData { FormNumber = "I-765", FormName = "Application for Employment Authorization", Description = "Used to request work authorization (EAD).", FormUrl = "https://www.uscis.gov/i-765", EstimatedTimeMinutes = 90, DefaultPricing = new PricingSeedData { SelfFilePrice = 200m, ParalegalPrice = 400m, LawyerPrice = 800m, LLCFee = 100m } },
            new FormSeedData { FormNumber = "I-131", FormName = "Application for Travel Document", Description = "Used to request Advance Parole or a Re-entry Permit.", FormUrl = "https://www.uscis.gov/i-131", EstimatedTimeMinutes = 90, DefaultPricing = new PricingSeedData { SelfFilePrice = 300m, ParalegalPrice = 500m, LawyerPrice = 1000m, LLCFee = 150m } },
            ...
            new FormSeedData { FormNumber = "I-539", FormName = "Application To Extend/Change Nonimmigrant Status", Description = "Used to extend stay or change to another nonimmigrant status while in the United States.", FormUrl = "https://www.uscis.gov/i-539", EstimatedTimeMinutes = 120, DefaultPricing = new PricingSeedData { SelfFilePrice = 400m, ParalegalPrice = 800m, LawyerPrice = 1500m, LLCFee = 200m } },
