...
import { Card, Button, useToast, useQuery } from '@l4h/shared-ui'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">
            Monitor and track the immigration cases of children under your guardianship.
          </p>
        </div>
          ...
          <Card className="text-center py-12">
            <div className="text-gray-500 dark:text-gray-400">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                You are not currently a guardian for any children with active immigration cases.
              </p>
            </div>
          </Card>
        ) : (
              ...
              <Card key={`${child.childUserId}-${index}`} className="overflow-hidden">
                ...
                {child.cases.length === 0 ? (
                  <div className="px-6 py-8 text-center">
                    <p className="text-gray-500 dark:text-gray-400">
                      No active cases for this child
                    </p>
                  </div>
                ) : (
                          ...
                          <div className="flex-1">
                            <div className="flex items-center space-x-3">
                              <h4 className="text-base font-medium text-gray-900 dark:text-gray-100">
                                {caseInfo.visaType || 'Immigration Case'}
                              </h4>
                              <span
