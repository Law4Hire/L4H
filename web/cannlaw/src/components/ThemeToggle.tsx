...
import { useTheme } from '@l4h/shared-ui'
...
export const ThemeToggle: React.FC = () => {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-navy-800 transition-colors focus:outline-none focus:ring-2 focus:ring-gold-500"
