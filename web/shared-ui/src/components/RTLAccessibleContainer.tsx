 ...
 */
export const RTLAccessibleContainer = forwardRef<HTMLElement, RTLAccessibleContainerProps>(({
  children,
  ...
  useEffect(() => {
    ...
    if (!container || !manageFocusOrder) return
 ...
 */
export const RTLAccessibleForm = forwardRef<HTMLFormElement, Omit<RTLAccessibleContainerProps, 'as'>>(
  (props, ref) => (
 ...
 */
export const RTLAccessibleNavigation = forwardRef<HTMLElement, Omit<RTLAccessibleContainerProps, 'as'> & {
  /**
 ...
 */
export const RTLAccessibleDialog = forwardRef<HTMLDivElement, Omit<RTLAccessibleContainerProps, 'as'> & {
  /**
 ...
 */
export const RTLAccessibleTable = forwardRef<HTMLTableElement, Omit<RTLAccessibleContainerProps, 'as' | 'children'> & {
  /**
   * Table content
   */
  children: React.ReactNode
