...
describe('useTranslationErrorHandling', () => {
  ...
  it('should reset notification dismissed state on language change', () => {
    const { result, rerender } = renderHook(
      ({ language }) => useTranslationErrorHandling(language, 'interview'),
      { initialProps: { language: 'fr-FR' } }
    )
  ...
  it('should check if translation exists', () => {
    mockT.mockImplementation((key: string) => key === 'existing.key' ? 'Translation' : key)
