...
class NewLanguageManager {
   ...
   */
  async addLanguage(languageCode: string, options: {
   ...
   */
  private async addLanguageToApplication(
    languageCode: string,
    app: ApplicationConfig,
    options: { copyFromBase: boolean; generatePlaceholders: boolean }
  ): Promise<void> {
   ...
   */
  private generatePlaceholderTranslations(obj: any, languageCode: string, _prefix = ''): any {
    const result: any = {};
   ...
   */
  private createEmptyStructure(obj: any): any {
    const result: any = {};
   ...
   */
  private async updateConfigurationFiles(languageCode: string, languageConfig: LanguageConfig): Promise<void> {
   ...
   */
  private async updateI18nConfig(languageCode: string, languageConfig: LanguageConfig): Promise<void> {
   ...
   */
  private async updatePackageJsonScripts(languageCode: string): Promise<void> {
   ...
   */
  private async updateLanguageConstants(languageCode: string, languageConfig: LanguageConfig): Promise<void> {
