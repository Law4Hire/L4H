...
class TranslationKeyMigrator {
     ...
     */
    async migrateTranslationFiles(migration, app) {
        const filesUpdated = [];
        const errors = [];
     ...
     */
    async migrateCodeFiles(migration, app) {
        const codeFilesUpdated = [];
        const errors = [];
        try {
     ...
     */
    async updateCodeFile(filePath, migration) {
     ...
     */
    async loadMigrationsFromFile(filePath) {
     ...
     */
    generateMigrationTemplate(outputPath) {
        const template = [
            {
