...
export class TranslationPerformanceMonitor {
    constructor(thresholds = {}) {
        ...
        Object.defineProperty(this, "alertCallbacks", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
    ...
    generateReport(timeRangeMs = 3600000) {
        ...
        const compressionMetrics = relevantMetrics.filter(m => m.operation === 'compression' || m.operation === 'decompression');
     ...
     * Clear old alerts
     */
    clearAlerts(olderThanMs = 3600000) {
    ...
    setupPerformanceHooks() {
        ...
        translationCacheManager.get = (language, namespace) => {
    ...
    checkPerformanceTrends(metrics) {
    ...
    calculateCompressionSavings(compressionMetrics) {
    ...
    calculateLanguagePerformance(metrics) {
    ...
    calculateNamespacePerformance(metrics) {
    ...
    getEmptyReport(startTime, endTime) {
        return {
